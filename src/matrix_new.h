...
struct Mat3 {
    ...
    Vec3 GetCol(int c) const {
        assert(c >= 0 && c < 3);
        int colStart = 3*c;
        return Vec3(colStart, colStart + 1, colStart + 2);
    }
...
struct Mat4 {
    ...
    Vec4 GetCol(int c) const {
        assert(c >= 0 && c < 4);
        int colStart = 4*c;
        return Vec4(colStart, colStart + 1, colStart + 2, colStart + 3);
    }

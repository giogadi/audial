...
std::unordered_map<std::string, SeqActionType> const gStringToSeqActionType = {
    ...
    { "SetEnemyHittable", SeqActionType::SetEnemyHittable },
    
    { "Respawn", SeqActionType::Respawn },
    
    { "AddMotion", SeqActionType::AddMotion },
    
    { "RandomizeText", SeqActionType::RandomizeText },
    
    { "ChangeText", SeqActionType::ChangeText },
    
    { "SetBpm", SeqActionType::SetBpm },
    ...
    { "ShufflePositions", SeqActionType::ShufflePositions }
